    ...
    duration-700  sm:inset-x-6'>
        ...
        <nav className='flex  size-full items-center justify-between p-4'>
            ...
            <div className='flex items-center gap-7 '>
                ...
                <Button id={"product"} title={"product"}  leftIcon={<TiArrowLeft/>}
    ...
    >
      {item}
                ...
                <button onClick={toggleAudioIndicator} className='ml-10 flex items-center  space-x-0.5'>
                    ...
                    {[1,2,3,4].map((bar)=> (<div key={bar} className={`indicator-line${isIndicatorActive ? "active" : ""}`} style={{animationDelay:`${bar*0.1}s`}}/>
